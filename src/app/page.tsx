      ...
      <section className='h-full px-4 flex flex-col justify-between'>
        <div className="flex flex-col gap-2">
          ...
          <p className='text-[1em] 2xl:text-[1.5em] p-1 mt-4 bg-background/20 backdrop-blur-sm sm:bg-transparent sm:backdrop-blur-none rounded drop-shadow'>
            ACADEMIA revolutionizes education by providing seamless access to academic resources. <br className='hidden sm:block' /> Students can effortlessly discover, browse, and download study materials, <br className='block sm:hidden' /> while faculty members can easily share knowledge and <br className='hidden sm:block' /> contribute to the learning ecosystem.</p>
        </div>
        ...
        <div className='h-full flex flex-col justify-end gap-4 pb-4'>
          ...
          <p className='flex_center sm:text-[1.2em] drop-shadow-md text-white'>© Copyright {new Date().getFullYear()} Abhijeet Patil</p>
        </div>
      </section>
