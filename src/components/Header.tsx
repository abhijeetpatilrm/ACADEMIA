        ...
        <header className={cn('flex justify-between items-center z-20', className)}>
            <div className="flex_center gap-3">
                ...
                <h1
                    ...
                    className='text-[2em] font-bold leading-8'>ACADEMIA</h1>
            </div>
            ...
            <div
                ...
                <nav className='w-[60%] h-full ml-auto flex flex-col justify-start items-center gap-4 pt-8 bg-background shadow text-[1.5em] tracking-wider'>
                    ...
                    <Link href="https://abhijeetpatil-portfolio.netlify.app/" target='_blank'>Portfolio</Link>
                    <Link href="https://github.com/abhijeetpatilrm" target='_blank'>GitHub</Link>
